        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">{{$voluntario->nombre}}
              </h3>
              <h3 class="profile-username text-center">{{$voluntario->apellido}}
              </h3>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Servicios</a></li>
              <li><a href="#timeline" data-toggle="tab">Horas en Servicio</a></li>
